    ...
    >
      ...
      <div className="absolute top-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-all duration-200 z-10">
        <motion.a
          ...
          className="w-8 h-8 bg-purple-500/20 hover:bg-purple-500/30 border border-purple-400/30 hover:border-purple-400/50 rounded-lg flex items-center justify-center transition-all duration-200"
        ...
        {onDelete && (
          <motion.button
            ...
            className="w-8 h-8 bg-red-500/20 hover:bg-red-500/30 border border-red-400/30 hover:border-red-400/50 rounded-lg flex items-center justify-center transition-all duration-200"
